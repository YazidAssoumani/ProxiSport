<<<<<<< 6bb1d99e9cdff3c125308bf1307819582bf8aa62
=======
...
// GET Maps listing.
  ...
  router.get('/', function(data, res, next) {

  //  var [lat,lng] = req.query.coords.split(',');
  //  var sports_choisi = req.query.sports;
  console.log(data)
    DB.collection('maps').find({lon: 5.94<lon<6.0, lat: 46<lat<47, type : type_saisie }).toArray(function(err, maps){
      if(err) throw err ;
