...
router.delete('/:id', function(req, res, next) {
  ...
  ////////route modifier avis 
  ////pas encore finalisé faute de temps
//   router.put('/:id/:idavis', function(req, res, next) { 
//     router.put('/:idlieu', function(req, res, next) { 

//     var body = req.body ;
//     body.idlieu = req.params.idlieu;
...
//   DB.collection("comments").updateOne(body.idlieu, body, function(err, result) {
//     if (err) throw err;
